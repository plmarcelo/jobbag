...
final class Version20181007170321 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql("INSERT INTO location (iso_code, parent_id, country_id, name) (SELECT 'ES-VI', l.id, 'ES', 'Álava' FROM location l WHERE l.iso_code ='ES-PV');");
        $this->addSql("INSERT INTO location (iso_code, parent_id, country_id, name) (SELECT 'ES-AB', l.id, 'ES', 'Albacete' FROM location l WHERE l.iso_code ='ES-AB');");
        $this->addSql("INSERT INTO location (iso_code, parent_id, country_id, name) (SELECT 'ES-A', l.id, 'ES', 'Alicante' FROM location l WHERE l.iso_code ='ES-VC');");
        $this->addSql("INSERT INTO location (iso_code, parent_id, country_id, name) (SELECT 'ES-AL', l.id, 'ES', 'Almería' FROM location l WHERE l.iso_code ='ES-AN');");
        $this->addSql("INSERT INTO location (iso_code, parent_id, country_id, name) (SELECT 'ES-O', l.id, 'ES', 'Asturias' FROM location l WHERE l.iso_code ='ES-AS');");
        $this->addSql("INSERT INTO location (iso_code, parent_id, country_id, name) (SELECT 'ES-AV', l.id, 'ES', 'Ávila' FROM location l WHERE l.iso_code ='ES-CL');");
        $this->addSql("INSERT INTO location (iso_code, parent_id, country_id, name) (SELECT 'ES-BA', l.id, 'ES', 'Badajoz' FROM location l WHERE l.iso_code ='ES-EX');");
        $this->addSql("INSERT INTO location (iso_code, parent_id, country_id, name) (SELECT 'ES-PM', l.id, 'ES', 'Baleares' FROM location l WHERE l.iso_code ='ES-IB');");
        $this->addSql("INSERT INTO location (iso_code, parent_id, country_id, name) (SELECT 'ES-B', l.id, 'ES', 'Barcelona' FROM location l WHERE l.iso_code ='ES-CT');");
        $this->addSql("INSERT INTO location (iso_code, parent_id, country_id, name) (SELECT 'ES-BI', l.id, 'ES', 'Vizcaya' FROM location l WHERE l.iso_code ='ES-PV');");
        $this->addSql("INSERT INTO location (iso_code, parent_id, country_id, name) (SELECT 'ES-BU', l.id, 'ES', 'Burgos' FROM location l WHERE l.iso_code ='ES-CL');");
        $this->addSql("INSERT INTO location (iso_code, parent_id, country_id, name) (SELECT 'ES-CC', l.id, 'ES', 'Cáceres' FROM location l WHERE l.iso_code ='ES-EX');");
        $this->addSql("INSERT INTO location (iso_code, parent_id, country_id, name) (SELECT 'ES-CA', l.id, 'ES', 'Cádiz' FROM location l WHERE l.iso_code ='ES-AN');");
        $this->addSql("INSERT INTO location (iso_code, parent_id, country_id, name) (SELECT 'ES-S', l.id, 'ES', 'Cantabria' FROM location l WHERE l.iso_code ='ES-CB');");
        $this->addSql("INSERT INTO location (iso_code, parent_id, country_id, name) (SELECT 'ES-CS', l.id, 'ES', 'Castellón' FROM location l WHERE l.iso_code ='ES-VC');");
        $this->addSql("INSERT INTO location (iso_code, parent_id, country_id, name) (SELECT 'ES-CR', l.id, 'ES', 'Ciudad Real' FROM location l WHERE l.iso_code ='ES-CM');");
        $this->addSql("INSERT INTO location (iso_code, parent_id, country_id, name) (SELECT 'ES-CO', l.id, 'ES', 'Córdoba' FROM location l WHERE l.iso_code ='ES-AN');");
        $this->addSql("INSERT INTO location (iso_code, parent_id, country_id, name) (SELECT 'ES-CU', l.id, 'ES', 'Cuenca' FROM location l WHERE l.iso_code ='ES-CM');");
        $this->addSql("INSERT INTO location (iso_code, parent_id, country_id, name) (SELECT 'ES-SS', l.id, 'ES', 'Guipúzcoa' FROM location l WHERE l.iso_code ='ES-PV');");
        $this->addSql("INSERT INTO location (iso_code, parent_id, country_id, name) (SELECT 'ES-GI', l.id, 'ES', 'Gerona' FROM location l WHERE l.iso_code ='ES-CT');");
        $this->addSql("INSERT INTO location (iso_code, parent_id, country_id, name) (SELECT 'ES-GR', l.id, 'ES', 'Granada' FROM location l WHERE l.iso_code ='ES-AN');");
        $this->addSql("INSERT INTO location (iso_code, parent_id, country_id, name) (SELECT 'ES-GU', l.id, 'ES', 'Guadalajara' FROM location l WHERE l.iso_code ='ES-CM');");
        $this->addSql("INSERT INTO location (iso_code, parent_id, country_id, name) (SELECT 'ES-H', l.id, 'ES', 'Huelva' FROM location l WHERE l.iso_code ='ES-AN');");
        $this->addSql("INSERT INTO location (iso_code, parent_id, country_id, name) (SELECT 'ES-HU', l.id, 'ES', 'Huesca' FROM location l WHERE l.iso_code ='ES-AR');");
        $this->addSql("INSERT INTO location (iso_code, parent_id, country_id, name) (SELECT 'ES-J', l.id, 'ES', 'Jaén' FROM location l WHERE l.iso_code ='ES-AN');");
        $this->addSql("INSERT INTO location (iso_code, parent_id, country_id, name) (SELECT 'ES-LO', l.id, 'ES', 'La Rioja' FROM location l WHERE l.iso_code ='ES-RI');");
        $this->addSql("INSERT INTO location (iso_code, parent_id, country_id, name) (SELECT 'ES-GC', l.id, 'ES', 'Las Palmas' FROM location l WHERE l.iso_code ='ES-CN');");
        $this->addSql("INSERT INTO location (iso_code, parent_id, country_id, name) (SELECT 'ES-LE', l.id, 'ES', 'León' FROM location l WHERE l.iso_code ='ES-CL');");
        $this->addSql("INSERT INTO location (iso_code, parent_id, country_id, name) (SELECT 'ES-L', l.id, 'ES', 'Lérida' FROM location l WHERE l.iso_code ='ES-CT');");
        $this->addSql("INSERT INTO location (iso_code, parent_id, country_id, name) (SELECT 'ES-LU', l.id, 'ES', 'Lugo' FROM location l WHERE l.iso_code ='ES-GA');");
        $this->addSql("INSERT INTO location (iso_code, parent_id, country_id, name) (SELECT 'ES-M', l.id, 'ES', 'Madrid' FROM location l WHERE l.iso_code ='ES-MD');");
        $this->addSql("INSERT INTO location (iso_code, parent_id, country_id, name) (SELECT 'ES-MA', l.id, 'ES', 'Málaga' FROM location l WHERE l.iso_code ='ES-AN');");
        $this->addSql("INSERT INTO location (iso_code, parent_id, country_id, name) (SELECT 'ES-MU', l.id, 'ES', 'Murcia' FROM location l WHERE l.iso_code ='ES-MC');");
        $this->addSql("INSERT INTO location (iso_code, parent_id, country_id, name) (SELECT 'ES-NA', l.id, 'ES', 'Navarra' FROM location l WHERE l.iso_code ='ES-NC');");
        $this->addSql("INSERT INTO location (iso_code, parent_id, country_id, name) (SELECT 'ES-OR', l.id, 'ES', 'Orense' FROM location l WHERE l.iso_code ='ES-GA');");
        $this->addSql("INSERT INTO location (iso_code, parent_id, country_id, name) (SELECT 'ES-P', l.id, 'ES', 'Palencia' FROM location l WHERE l.iso_code ='ES-CL');");
        $this->addSql("INSERT INTO location (iso_code, parent_id, country_id, name) (SELECT 'ES-PO', l.id, 'ES', 'Pontevedra' FROM location l WHERE l.iso_code ='ES-GA');");
        $this->addSql("INSERT INTO location (iso_code, parent_id, country_id, name) (SELECT 'ES-SA', l.id, 'ES', 'Salamanca' FROM location l WHERE l.iso_code ='ES-CL');");
        $this->addSql("INSERT INTO location (iso_code, parent_id, country_id, name) (SELECT 'ES-TF', l.id, 'ES', 'Santa Cruz de Tenerife' FROM location l WHERE l.iso_code ='ES-CN');");
        $this->addSql("INSERT INTO location (iso_code, parent_id, country_id, name) (SELECT 'ES-SG', l.id, 'ES', 'Segovia' FROM location l WHERE l.iso_code ='ES-CL');");
        $this->addSql("INSERT INTO location (iso_code, parent_id, country_id, name) (SELECT 'ES-SE', l.id, 'ES', 'Sevilla' FROM location l WHERE l.iso_code ='ES-AN');");
        $this->addSql("INSERT INTO location (iso_code, parent_id, country_id, name) (SELECT 'ES-SO', l.id, 'ES', 'Soria' FROM location l WHERE l.iso_code ='ES-CL');");
        $this->addSql("INSERT INTO location (iso_code, parent_id, country_id, name) (SELECT 'ES-T', l.id, 'ES', 'Tarragona' FROM location l WHERE l.iso_code ='ES-CT');");
        $this->addSql("INSERT INTO location (iso_code, parent_id, country_id, name) (SELECT 'ES-TE', l.id, 'ES', 'Teruel' FROM location l WHERE l.iso_code ='ES-AR');");
        $this->addSql("INSERT INTO location (iso_code, parent_id, country_id, name) (SELECT 'ES-TO', l.id, 'ES', 'Toledo' FROM location l WHERE l.iso_code ='ES-CM');");
        $this->addSql("INSERT INTO location (iso_code, parent_id, country_id, name) (SELECT 'ES-V', l.id, 'ES', 'Valencia' FROM location l WHERE l.iso_code ='ES-VC');");
        $this->addSql("INSERT INTO location (iso_code, parent_id, country_id, name) (SELECT 'ES-VA', l.id, 'ES', 'Valladolid' FROM location l WHERE l.iso_code ='EX-CL');");
        $this->addSql("INSERT INTO location (iso_code, parent_id, country_id, name) (SELECT 'ES-ZA', l.id, 'ES', 'Zamora' FROM location l WHERE l.iso_code ='ES-CL');");
        $this->addSql("INSERT INTO location (iso_code, parent_id, country_id, name) (SELECT 'ES-Z', l.id, 'ES', 'Zaragoza' FROM location l WHERE l.iso_code ='ES-AR');");
